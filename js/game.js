class Game{
    ...
    start(){
        ...
        this.addSprites(obsG1, obsImg1, obstacles1.length, 0.3, obstacles1)
        this.addSprites(obsG2, obsImg2, obstacles2.length, 0.3, obstacles2)
    ...
    gameOver(){
        swal({
            title:"Que pena",
            text:"Parece que voce pulou algum filme dos Velozes e Furiosos",
            imageUrl:"https://media1.giphy.com/media/IUxFvKwD3jXisqR5w7/giphy.gif",
            imageSize:"300x300",
    ...
    mostrarRank() {
        swal({
          title: "Parabens" +player.rank+ " ° Lugar!",
          text: "Parece que voce assistiu todos os Velozes e Furiosos",
          imageUrl:"https://thumbs.gfycat.com/SpecificVastBadger-size_restricted.gif"   ,      
          imageSize: "200x200",
          confirmButtonText: "Ok"
        });
      }
